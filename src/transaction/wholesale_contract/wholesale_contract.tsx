...
const WholesaleContractView = ({ contract, onUpdate, onDelete }: WholesaleContractViewProps) => {
      ...
      <div className="px-6 py-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-gray-900">{formatDate(contract.shipment_date)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Contract Status</p>
            <StatusBadge status={contract.contract_status} type="contract" />
          </div>
          <div>
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-900">{contract.total_price ? formatPrice(contract.total_price) : 'Not set'}</p>
          </div>
          {contract.note && (
            <div className="col-span-2">
              <p className="text-sm text-gray-500">Note</p>
              <p className="text-gray-900">{contract.note}</p>
            </div>
          )}
        </div>
...
export default WholesaleContractView; 