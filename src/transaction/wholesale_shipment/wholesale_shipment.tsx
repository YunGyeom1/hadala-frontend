...
const WholesaleShipmentView = ({ shipment, onUpdate, onDelete }: WholesaleShipmentViewProps) => {
      ...
      <div className="px-6 py-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-gray-900">{shipment.farmer_id}</p>
          </div>
          <div>
...
export default WholesaleShipmentView; 